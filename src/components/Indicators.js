...
class Indicators extends Component {
	...
	render() {
		...
		return (<section id="indicatorsSection" className="indicators">
			<div className="indicators__background">
				<div className="block__container indicators__container">
					<div className="indicators__description">
						...
						<p className="indicators__description--text">Recibe hasta 150€ de datos inmobiliarios gratis
						</p>
					</div>
