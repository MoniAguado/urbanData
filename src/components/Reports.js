				...
				<div className="block__container">
					<div className="reports__container">
						...
						<div className="reports__description">
							...
							<a href="https://inversionesinmobiliarias.elmundo.es/common/docs/Ficha%20ejemplo.pdf" target="_blank" className="button--report" rel="noopener noreferrer">Descargar ejemplo
							</a>
